...
#define STRING_CONFIG_H_AUTHOR "(Sean Walsh, Sapphire Plus, Std Config )" // Who made the changes.
...
#define USE_ZMAX_PLUG // option For BL Touch  specify PC4
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.2, 80.2, 400, 412 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -38.0, -0.7 }
