...
#define HOMING_BACKOFF_POST_MM { 3, 25, 5 }  // (mm) Backoff from endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 150*60, 150*60, 15*60, 60 } // Feedrates for manual moves along X, Y, Z, E from panel
